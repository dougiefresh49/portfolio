const MarginImpactProject = {
  ...
  imageCards: {
    type: 'column',
    images: ['/portfolio/jack-trade-ticket.webp']
  }
}
...
const WatchlistProject = {
  ...
  imageCards: {
    type: 'column',
    images: ['/portfolio/odin-watchlist.webp']
  }
}
...
const TradeTicketProject = {
  ...
  imageCards: {
    type: 'column',
    images: ['/portfolio/loki-computer.webp']
  }
}
...
export const FidelityProjectClusters = [
  WatchlistProject,
  MarginImpactProject,
  TradeTicketProject
]

export const FreelanceProjectClusters = [
  EmilyJeanProject,
  GfwkProject,
  RapidRosterProject
]
